...
window_xmin = 2 * min ( min ( rjt(:,1,:) ) );
window_xmax = 2 * max ( max ( rjt(:,1,:) ) );
window_ymin = 2 * min ( min ( rjt(:,2,:) ) );
window_ymax = 2 * max ( max ( rjt(:,2,:) ) );
window_zmin = 2 * min ( min ( rjt(:,3,:) ) );
window_zmax = 2 * max ( max ( rjt(:,3,:) ) );
